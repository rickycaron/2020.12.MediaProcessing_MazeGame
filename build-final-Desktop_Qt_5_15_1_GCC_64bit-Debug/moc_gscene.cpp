/****************************************************************************
** Meta object code from reading C++ file 'gscene.h'
**
...
#include <memory>
#include "../final/gscene.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'gscene.h' doesn't include <QObject>."
...
void GScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GScene::*)(int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GScene::poisonTile)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GScene::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsScene::staticMetaObject>(),
    qt_meta_stringdata_GScene.data,
    qt_meta_data_GScene,
    qt_static_metacall,
    nullptr,
    nullptr
...
// SIGNAL 0
void GScene::poisonTile(int _t1, int _t2, int _t3)
{
