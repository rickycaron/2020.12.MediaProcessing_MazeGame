...
QT_MOC_LITERAL(1, 6, 16), // "mouseClickSignal"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 1), // "x"
QT_MOC_LITERAL(4, 26, 1), // "y"
QT_MOC_LITERAL(5, 28, 14), // "keyPressSignal"
QT_MOC_LITERAL(6, 43, 5) // "index"

    },
    "GView\0mouseClickSignal\0\0x\0y\0keyPressSignal\0"
    "index"
};
...
void GView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GView::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GView::mouseClickSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GView::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GView::keyPressSignal)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GView::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsView::staticMetaObject>(),
    qt_meta_stringdata_GView.data,
    qt_meta_data_GView,
    qt_static_metacall,
    nullptr,
    nullptr
...
// SIGNAL 0
void GView::mouseClickSignal(int _t1, int _t2)
{
...
// SIGNAL 1
void GView::keyPressSignal(int _t1)
{
